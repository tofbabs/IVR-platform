...
!function (e, t) {
    ...
    i(u, [], function () {
                ...
                define_property: function () {
                    ...
                    try {
                        ...
                        if (window.XMLHttpRequest) {
                            ...
                            if (n.open("get-2.html", "http://demo.interface.club/"), "responseType" in n)return n.responseType = t, n.responseType === t
                        }
                    } catch (i) {
                    }
                    return !1
        ...
        function i(i, r) {
            ...
            var o;
            if (r.name)o = r.name.replace(/\\/g, "http://demo.interface.club/"), o = o.substr(o.lastIndexOf("http://demo.interface.club/") + 1); else if (this.type) {
                var a = this.type.split("http://demo.interface.club/")[0];
        ...
        var e = function (t, n) {
            ...
            return a.port || (a.port = o[a.scheme] || 80), a.port = parseInt(a.port, 10), a.path || (a.path = "http://demo.interface.club/"), delete a.source, a
        }, t = function (t) {
            var n = {http: 80, https: 443}, i = "object" == typeof t ? t : e(t);
            return i.scheme + "://" + i.host + (i.port !== n[i.scheme] ? ":" + i.port : "") + i.path + (i.query ? i.query : "")
        }, n = function (t) {
            function n(e) {
                return [e.scheme, e.host, e.port].join("http://demo.interface.club/")
            }
        ...
        function f() {
            ...
            function v(e, t) {
                var n = this, i;
                i = new r, i.open("get-2.html", e), i.responseType = "blob", i.onprogress = function (e) {
                    n.trigger(e)
                }, i.onload = function () {
