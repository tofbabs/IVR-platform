...
(function (h) {
    ...
    (function (f) {
        var h = f.defaultOptions, q = f.doc, u = f.Chart, v = f.addEvent, D = f.removeEvent, E = f.fireEvent, r = f.createElement, w = f.discardElement, x = f.css, p = f.merge, B = f.pick, k = f.each, t = f.extend, H = f.splat, I = f.isTouchDevice, F = f.win, J = f.Renderer.prototype.symbols;
        t(h.lang, {
        ...
        f.post = function (a, c, e) {
            var b;
            a = r("form", p({method: "post", action: a, enctype: "multipart/form-data"}, e), {display: "none"}, q.body);
            for (b in c)r("input", {type: "hidden", name: b, value: c[b]}, null, a);
            a.submit();
            w(a)
        };
        t(u.prototype, {
            sanitizeSVG: function (a) {
                ...
                var c = this, e, b, g, C, l, d = p(c.options, a), m = d.exporting.allowHTML;
                q.createElementNS ||
                ...
                t(d.chart, {animation: !1, renderTo: b, forExport: !0, renderer: "SVGRenderer", width: g, height: l});
                ...
                k(["xAxis", "yAxis"], function (a) {
                    k(c[a], function (b, c) {
                        var d = e[a][c], g = b.getExtremes(), f = g.userMin, g = g.userMax;
                ...
                return this.getSVG(p({chart: {borderRadius: 0}}, e.chartOptions, c, {
                    exporting: {
            ...
            exportChart: function (a, c) {
                ...
                var a = this, c = a.container, e = [], b = c.parentNode, g = q.body, f = g.childNodes, l = a.options.exporting.printMaxWidth, d, m;
                if (!a.isPrinting) {
                    a.isPrinting = !0;
                ...
                var d = this, m = d.options.navigation, h = d.chartWidth, p = d.chartHeight, G = "cache-" + a, n = d[G], y = Math.max(g, f), z, A, u, w = function (b) {
                    d.pointer.inClass(b.target, a) || A()
                };
                n || (d[G] = n = r("div", {className: a}, {
                    position: "absolute",
                    zIndex: 1E3, padding: y + "px"
                }, d.container), z = r("div", {className: "highcharts-menu"}, null, n), x(z, t({
                    ...
                    if (a) {
                        ...
                        }, x(b, t({cursor: "pointer"}, m.menuItemStyle)));
                ...
                var c = this, e = c.renderer, b = p(c.options.navigation.buttonOptions, a), g = b.onclick, f = b.menuItems, l, d, m = b.symbolSize || 12;
                c.btnCount || (c.btnCount = 0);
                c.exportDivElements || (c.exportDivElements = [], c.exportSVGElements = []);
                if (!1 !== b.enabled) {
                    var h = b.theme, k = h.states, q = k && k.hover, k = k && k.select, n;
                    delete h.states;
                    g ? n = function (a) {
                        a.stopPropagation();
                        g.call(c, a)
                    ...
                    b.symbol && (l = e.symbol(b.symbol, b.symbolX - m / 2, b.symbolY - m / 2, m, m).addClass("highcharts-button-symbol").attr({zIndex: 1}).add(d),
                        l.attr({stroke: b.symbolStroke, fill: b.symbolFill, "stroke-width": b.symbolStrokeWidth || 1}));
                    d.add().align(t(b, {width: d.width, x: B(b.x, c.buttonOffset)}), !0, "spacingBox");
